...
while True:
  ...
  def straight(dice):
      ...
      if straight == 4:
          ...
          return SmallStraight.append(30)
      elif straight ==5:
          print("Je hebt een Large Straight gescoord: 40 punten.\n\n")
          return LargeStraight.append(40)
      else:
          return 0
  ...
  def Gameplay():
      ...
      for x in range(1,6):
          ...
          save = input("Welke nummers wil je achterhouden? 1st  2nd  3rd  4th  5th\n")
          save = save.split(',')
          print("Roll 2: ", end ="")
          for x in range(5):
